...
- Layouts with `Column`, `Center`, `Card`, and `ListTile`  
- Styling with fonts, colors, and icons  
- Clickable social media buttons (LinkedIn, GitHub, Telegram) using `url_launcher`
...
1. App starts with your **profile image, name, and profession**  
2. Displays **phone number** and **email**  
3. Social buttons are clickable and open the respective URL in a browser  
